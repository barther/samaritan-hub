-- Normalize and finalize RLS policies by first removing any partially-created policies

-- Assistance Requests: drop any previous hardened policies if present
